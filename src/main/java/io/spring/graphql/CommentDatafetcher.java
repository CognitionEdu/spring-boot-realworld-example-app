...
public class CommentDatafetcher {
  ...
  private Comment buildCommentResult(CommentData comment) {
    return Comment.newBuilder()
        ...
        .updatedAt(DateTimeFormatter.ISO_LOCAL_DATE_TIME.format(comment.getCreatedAt()))
        .createdAt(DateTimeFormatter.ISO_LOCAL_DATE_TIME.format(comment.getCreatedAt()))
        .build();
  }
}
