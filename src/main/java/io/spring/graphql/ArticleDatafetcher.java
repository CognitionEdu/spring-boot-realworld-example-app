...
public class ArticleDatafetcher {
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(DateTimeFormatter.ISO_LOCAL_DATE_TIME.format(articleData.getCreatedAt()))
        ...
        .updatedAt(DateTimeFormatter.ISO_LOCAL_DATE_TIME.format(articleData.getUpdatedAt()))
        .build();
  }
}
